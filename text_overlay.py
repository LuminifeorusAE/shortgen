...
class VideoTextOverlay:
    ...
    def _get_next_caption(self):
        ...
        # Increments the last used index, wraps it around if it exceeds the number of caption files, and updates the index file.
        with open(text_file_path, "r") as file:
            text = file.readline().strip()
        self.last_index = (self.last_index + 1) % len(caption_files)
        with open(self.index_file, "w") as file:
            file.write(str(self.index_file,))
    ...
    def overlay_text_on_videos(self):
        ...
        for video_file in video_files:
            ...
            out_file = os.path.join(self.output_directory,video_file)
