...
class VideoDownloader():
    ...
    def download_video(self, video, output_folder):
        """
        Download a video, print its resolution, and extract metadata.
        """
        ...
        try:
            ...
            resolution = self.get_video_metadata(filepath)
...
if __name__ == "__main__":
    ...
    if videos:
        selected_videos = random.sample(videos, min(NUM_VIDEOS_TO_DOWNLOAD, len(videos)))
